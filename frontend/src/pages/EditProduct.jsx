            ...
            <div className="page">
                <div className="container">
                    <div style={{ textAlign: 'center', padding: '2rem' }}>
                        <h2>Access Denied</h2>
                        <p>Only admin users can edit products.</p>
                    </div>
                </div>
            </div>
        );
                ...
                <form onSubmit={handleSubmit} className="card" style={{ padding: '2rem' }}>
                    ...
                    <div className="grid-2">
                        <div className="form-group">
                            ...
                            <select
                                ...
                                value={form.category}
                                onChange={e => { handleChange('category', e.target.value); setSpecs({}); }}
                            >
                    ...
                    <div className="form-group">
                        ...
                        <textarea
                            ...
                            placeholder="Brief product review..."
                            value={form.review}
                    ...
                    <button type="submit" className="btn btn-primary auth-btn" disabled={saving} style={{ marginTop: '0.5rem' }}>
